...
def get_input_args_pred():
    ...
    parser.add_argument('--checkpoint', type=str, default='save_directorycheckpoint.pth', help='path where checkpoint is saved')

    parser.add_argument('--category_names', type=str, default='cat_to_name.json', help='map categories to real names')

    parser.add_argument('--image_name', type=str, default='image_07087.jpg', help='name of the image to be predicted')
